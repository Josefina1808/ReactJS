      ...
      <section className="solarizar">
        ...
        <div className="solarizar__content">
          <div className="solarizar__content--text">
            <p>
              Disfruta los beneficios del agua en su estado original. Cuando los
              rayos del sol atraviesan el vidrio azul, el agua obtiene una
            ...
            <p>
              ...
              directa del grifo o filtro, no plástico. Déjalas sin tapa para que
              evapore el cloro, cúbrelas con una servilleta de papel o gasa para
              que no absorba otra energía. En lo posible, pon música para
              armonizar el agua y el ambiente en que están. Usa frecuencia 432
              hz, es la nueva frecuencia de la tierra, o bien frecuencias de
              Solfeggio. Puedes ver nuestras playlists recomendadas en la{" "}
              <a href="html/galeria.html" target="_blank">
                galería musical
              </a>
              . Deja las botellas expuestas al sol por al menos 3 horas, no hay
              máximo de tiempo, puedes dejarlas durante la noche si lo deseas.
              Una vez que las retiras del sol, esa vibración se mantiene por 24
              horas. Puedes guardarla en el refrigerador y tomarla fría.
            </p>
            <p>
        ...
        <div className="codificar__content">
          <div className="codificar__content--text">
            <p>
              ...
              Metatrón. Estos patrones, junto a la palabra que elijas, le darán
              la información a las moléculas del agua que luego será transmitida
              a tus células y eso recibirás en tu vida. Los pasos para codificar
              tu agua son:
            </p>
            <ol>
              <li>
                1. Elegir una <a href="#geometria-sagrada">geometría sagrada</a>
                , La Flor de la Vida o Metatrón.
              </li>
              <li>
                2. <a href="#intencionar">Intencionar el agua</a> , debes elegir
                una palabra unida a la frase "Yosoy...". Por ejemplo:
                YoSoyCoherencia.
              </li>
            </ol>
          </div>
        ...
        <article>
          <div className="geometria">
            ...
            <div className="geometria__content">
              ...
              <div className="geometria__content--img img_radius" id="metatron">
                <a
                  className="geometria__content--img--text"
          ...
          <div className="intencionar">
            ...
            <div className="intencionar__content">
              <p className="intencionar__content--text">
                ...
                codificación. Podés elegir entre: Amor, Salud, Gracias, Balance,
                Equilibrio, Sabiduría, Abundancia, Coherencia, Conciencia y
                YoSoy. YoSoy puede ir combinada con cualquiera de las anteriores
                o simplemente sola. No hay una regla de palabras, simplemente
                las que desees son las correctas e indicadas para vos.
              </p>
